...
def main():
    ...
    parser.add_argument('--vo_config_path',      type=str, help='Path to yaml file with vo params',               default='configuration/vo_params.yaml')
    parser.add_argument('--cameras_params_path', type=str, help='Path to yaml file with cameras params',          default='configuration/cameras_params.yaml')
